...
extern void *mono_aot_module_MyShopiOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_MyShop_info;
...
extern void *mono_aot_module_Yelp_Api_info;
...
extern void *mono_aot_module_FormsToolkit_iOS_info;
extern void *mono_aot_module_FormsToolkit_info;
extern void *mono_aot_module_ImageCircle_Forms_Plugin_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_MyShopiOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_MyShop_info);
	...
	mono_aot_register_module (mono_aot_module_Yelp_Api_info);
	...
	mono_aot_register_module (mono_aot_module_FormsToolkit_iOS_info);
	mono_aot_register_module (mono_aot_module_FormsToolkit_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "MyShopiOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
