...
@class MyShop_iOS_Renderers_TransitionNavigationPageRenderer;
...
@class FormsToolkit_iOS_ListViewGroupedRenderer;
@class FormsToolkit_iOS_EntryLineRenderer;
@class FormsToolkit_iOS_NavigationPageNoLineRenderer;
...
@interface MyShop_iOS_Renderers_TransitionNavigationPageRenderer : Xamarin_Forms_Platform_iOS_NavigationRenderer {
}
...
@interface FormsToolkit_iOS_ListViewGroupedRenderer : Xamarin_Forms_Platform_iOS_ListViewRenderer {
}
	-(id) init;
@end

@interface FormsToolkit_iOS_EntryLineRenderer : Xamarin_Forms_Platform_iOS_EntryRenderer {
}
	-(void) drawRect:(CGRect)p0;
	-(id) init;
@end

@interface FormsToolkit_iOS_NavigationPageNoLineRenderer : Xamarin_Forms_Platform_iOS_NavigationRenderer {
}
	-(void) viewDidLoad;
	-(id) init;
@end
