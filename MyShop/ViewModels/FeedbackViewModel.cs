...
namespace MyShop
{
    public class FeedbackViewModel : ViewModelBase
    {
        ...
        public async Task<IEnumerable<CommonYelpClass>> GetStoreAsync()
        {
            if (IsBusy)
                return new List<CommonYelpClass>();

            IsBusy = true;
            try
            {
                return await dataStore.CreateObjectAsyncYelp() ?? new List<CommonYelpClass>();
