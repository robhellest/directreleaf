...
namespace MyShop
{
    public class StoreViewModel : ViewModelBase
    {
        ...
        public CommonYelpClass Store { get; set; }
        ...
        public string Address1 { get { return Store.Location; } }
        // public string Address2 { get { return string.Format("{0}, {1} {2}", Store.City, Store.State, Store.ZipCode); } }
        public string Address2 { get { return string.Format("{0}", Store.City); } }
        ...
        public Command NavigateCommand
        {
            get
            {
                ...
                CrossExternalMaps.Current.NavigateTo(Store.Name, Store.Coordinates.Latitude, Store.Coordinates.Longitude)));
            }
        }
            ...
            get
            {
                return callCommand ?? 
                    (callCommand = new Command(() =>
                        // PhoneDialer.Open(Store.Phone.CleanPhone())
                        Device.OpenUri(new Uri(String.Format("tel:{0}", Store.Phone)))
                    ));
            }
        }
